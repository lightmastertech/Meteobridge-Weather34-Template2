...
.cloudbase0,.cloudbase1500{font-family:'weathertext',Arial,Helvetica,system;width:8rem;height:7.68rem;font-size:1.70rem;padding-top:0;color:#fff;border-bottom: 15px solid rgba(56, 56, 60, 1);display:flex;align-items:center;justify-content:center;-webkit-border-radius: 3px;-moz-border-radius: 3px;-o-border-radius: 3px;border-radius: 3px;margin-left:-40px;margin-top:15px;}
