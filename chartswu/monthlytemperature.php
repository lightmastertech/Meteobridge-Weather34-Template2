...
<html>
	<head>
		...
		<title>OUTDOOR MONTH TEMPERATURE DATABASE CHART</title>	
...
<body>
<div class="weather34darkbrowser" url="<?php echo $stationlocation;?> <?php echo $lang['Temperature'] ;?> (<?php echo $tempunit ;?>) <?php echo strftime(" %B") ;?> <?php echo date(" Y") ;?>"></div>
