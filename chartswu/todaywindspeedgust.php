	...
	function processData1(allText) {
		...
		if(allLinesArray.length>0){
			...
			for (var i = 2; i <= allLinesArray.length-1; i++) {
				...
				if (rowData[6]>-1)
					dataPoints1.push({label:moment(rowData[0]).format('HH:mm'),y:parseFloat(rowData[6]*<?php echo $windconv ;?>)}); // windspeed
	...
	function processData2(allText) {
		...
		if(allLinesArray.length>-1){
			...
			for (var i = 2; i <= allLinesArray.length-1; i++) {
				var rowData = allLinesArray[i].split(',');
				if (rowData[7])
					dataPoints2.push({label:moment(rowData[0]).format('HH:mm'),y:parseFloat(rowData[7]*<?php echo $windconv ;?>)}); // windspeed
...
<body>
<div class="weather34darkbrowser" url="<?php echo $stationlocation;?> <?php echo $lang['Windspeed'] ;?> - <?php echo $lang['Gust'] ;?> (<?php echo $windunit ;?>)  <?php echo $lang['Today'];?>"></div>
