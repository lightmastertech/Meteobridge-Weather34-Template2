...
$indoorRefresh             = 15;	// Default 2 minutes
$notifyRefresh             = 17;	// Default 17 seconds
$tempRefresh               = 15; 	// Default 60 secondss
$skyRefresh                = 300; 	// Default 5 minutes 
$windSpeedRefresh          = 15; 	// Default 10 seconds
$baroRefresh               = 15; 	// Default 15 minutes
$windDirRefresh            = 15; 	// Default 10 seconds
$moonRefresh               = 1800; 	// Default 30 minutes 
$rainRefresh               = 15; 	// Default 50 seconds 
$solarRefresh              = 15; 	// Default 1 minutes 
$daylightRefresh           = 120;	// Default 2 minutes
$moonphaseRefresh          = 120;	// Default 2 minutes
$eqRefresh                 = 600;	// Default 10 minutes 
$forecastRefresh           = 300; 	// Default 15 minutes 
$notificationcenterRefresh = 300; 	// Default 5 minutes 		set refresh time for notification of earthquakes default 5 minutes
$wuupdate                  = 1800; 	// Default 30 minutes 
$wfupdate                  = 60; 	// Default 60 seconds 		weatherflow api
...
$templateversion    = 'MB-UB<maxred>40</maxred>-FFT';
