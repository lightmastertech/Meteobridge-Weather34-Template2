...
?></span>
    ...
    <div class="bar bar-1" style="height:100px;max-height:100px;"> 
    <?php
	if ($weather["solar"]>1000){echo '<div class="bar bar-inner1000" style="max-height:95px; height: ';echo $weather["solar"]/14;}	
	else if ($weather["solar"]>700){echo '<div class="bar bar-inner600" style="max-height:95px; height: ';echo $weather["solar"]/14;}
	else if ($weather["solar"]>500){echo '<div class="bar bar-inner400" style="max-height:95px; height: ';echo $weather["solar"]/14;}	
	else if ($weather["solar"]>200){echo '<div class="bar bar-inner300" style="max-height:95px; height: ';echo $weather["solar"]/12;}
	else if ($weather["solar"]>=1){echo '<div class="bar bar-inner1" style="max-height:95px; height: ';echo $weather["solar"]/12;}		
	else if ($weather["solar"]>=0){echo '<div class="bar bar-inner1" style="max-height:95px; height: ';echo $weather["solar"]+1;}	
...
<div class="provided">   
<a href="https://aqicn.org" title="https://aqicn.org" target="_blank">AQI Data Provided by https://aqicn.org</a> 
&nbsp;
