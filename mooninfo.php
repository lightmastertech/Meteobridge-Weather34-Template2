...
a{color:#aaa;text-decoration:none;font-family:weathertext2,Arial,Helvetica,system;}
body{font-family:weathertext2,Arial,Helvetica,system;font-weight:500}
