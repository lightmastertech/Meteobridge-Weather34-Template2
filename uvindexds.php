...
<path fill="<?php if ($weather["uv3"]>=10){echo 'rgba(116, 100, 192, 0.8)';}	else echo 'currentcolor';?>" d=" M 365.36 103.21 C 448.45 102.86 531.56 102.87 614.65 103.20 C 618.01 109.63 621.86 115.83 624.49 122.62 C 628.78 128.60 631.63 135.53 635.15 141.92 C 538.38 142.05 441.62 142.06 344.85 141.92 C 348.40 135.23 351.34 128.01 355.89 121.92 C 358.38 115.35 361.97 109.32 365.36 103.21 Z" />
<path fill="<?php if ($weather["uv3"]>=9){echo 'rgba(237, 73, 71, 0.8)';} else echo 'currentcolor';?>"d=" M 336.08 158.04 C 438.69 157.99 541.30 157.93 643.91 158.07 C 648.49 167.73 654.44 176.70 658.49 186.62 C 661.14 190.43 663.71 194.47 665.13 198.93 C 548.38 199.05 431.62 199.05 314.87 198.92 C 321.04 184.87 329.43 171.89 336.08 158.04 Z" />
<path fill="<?php if ($weather["uv3"]>=8){echo 'rgba(237, 73, 71, 0.8)';} else echo 'currentcolor';?>" d=" M 306.28 215.17 C 428.76 214.89 551.28 214.88 673.75 215.18 C 682.09 230.39 689.68 245.75 698.02 260.98 C 559.35 261.01 420.67 261.02 282.00 260.97 C 290.25 245.78 298.01 230.35 306.28 215.17 Z" />
<path fill="<?php if ($weather["uv3"]>=7){echo 'rgba(208,95,45,1)';} else echo 'currentcolor';?>" d=" M 273.33 277.19 C 417.80 276.86 562.31 276.91 706.77 277.16 C 715.16 293.95 724.34 310.34 733.02 326.99 C 571.02 327.01 409.02 327.02 247.03 326.98 C 255.55 310.16 264.54 293.84 273.33 277.19 Z" />
<path fill="<?php if ($weather["uv3"]>=6){echo 'rgba(208,95,45,1)';} else echo 'currentcolor';?>" d=" M 238.32 343.18 C 406.12 342.88 573.96 342.88 741.75 343.18 C 747.04 352.67 751.46 362.64 756.99 372.00 C 760.56 380.21 766.14 387.46 769.13 395.93 C 583.06 396.05 396.98 396.05 210.91 395.93 C 219.12 377.94 229.43 360.88 238.32 343.18 Z" />
<path fill="<?php if ($weather["uv3"]>=5){echo 'rgba(208,95,45,1)';} else echo 'currentcolor';?>"d=" M 201.31 412.18 C 393.79 411.86 586.31 411.91 778.78 412.15 C 786.97 430.19 797.63 447.15 806.12 464.93 C 595.39 465.05 384.65 465.04 173.92 464.94 C 182.32 447.09 192.76 430.04 201.31 412.18 Z" />
<path fill="<?php if ($weather["uv3"]>=4){echo 'rgba(237, 167, 8, 0.8)';} else echo 'currentcolor';?>" d=" M 165.17 481.10 C 381.75 480.90 598.33 481.00 814.91 481.05 C 822.14 494.55 829.45 508.01 836.33 521.71 C 839.46 527.32 843.00 532.83 845.13 538.93 C 608.38 539.05 371.62 539.05 134.86 538.92 C 138.62 529.13 144.48 520.39 149.05 510.99 C 154.83 501.25 159.22 490.74 165.17 481.10 Z" />
<path fill="<?php if ($weather["uv3"]>=3){echo 'rgba(237, 167, 8, 0.8)';} else echo 'currentcolor';?>" d=" M 125.36 555.16 C 368.45 554.89 611.55 554.89 854.64 555.16 C 857.46 560.61 860.95 565.93 863.17 571.85 C 867.36 577.00 869.52 583.57 872.56 589.48 C 877.07 594.10 877.62 601.36 881.96 606.05 C 884.38 610.97 887.32 615.73 889.13 620.93 C 623.06 621.05 356.98 621.05 90.91 620.93 C 94.59 610.88 100.90 602.01 105.31 592.28 C 110.35 586.23 111.63 577.81 116.82 571.85 C 119.04 565.93 122.54 560.61 125.36 555.16 Z" />
<path fill="<?php if ($weather["uv3"]>=2){echo 'rgba(146, 177, 42, 0.8)';} else echo 'currentcolor';?>" d=" M 81.31 637.18 C 353.79 636.86 626.31 636.91 898.78 637.16 C 906.01 653.63 915.67 668.54 923.22 684.82 C 927.18 690.19 930.08 696.53 932.10 702.93 C 637.39 703.05 342.67 703.04 47.96 702.93 C 49.21 696.12 53.57 689.92 57.16 684.13 C 64.21 667.89 74.16 653.32 81.31 637.18 Z" />
<path fill="<?php if ($weather["uv3"]>0){echo 'rgba(146, 177, 42, 0.8)';} else echo 'currentcolor';?>" d=" M 37.24 719.17 C 147.49 718.78 257.75 719.11 368.00 719.00 C 559.56 719.13 751.13 718.75 942.69 719.19 C 954.83 742.74 967.22 766.17 980.00 789.39 L 980.00 792.00 L 0.00 792.00 L 0.00 789.37 C 12.76 766.16 25.41 742.86 37.24 719.17 Z" />
</svg>
</div></div>
 <div class="weather34iuvrate"><?php 
 if ($weather["uv3"]>=10){echo  "<uv10>",number_format($weather["uv3"] ,0),"</<uv10>";}
	else if ($weather["uv3"]>=8){echo  "<uv8>",number_format($weather["uv3"] ,0), "</<uv8>";}
	else if ($weather["uv3"]>=5){echo  "<uv5>",number_format($weather["uv3"] ,0), "</uv5>";}
	else if ($weather["uv3"]>=3){echo  "<uv3>",number_format($weather["uv3"] ,0), "</uv3>";}
	else if ($weather["uv3"]>=0){echo  "<uv0>",number_format($weather["uv3"] ,0), "</uv0>";}
	else if ($weather["uv3"]>=0){echo  "<uv0>",number_format($weather["uv3"] ,0), "</uv0>";}
?>
 </span>
...
if ($weather["solar"]>=1000) echo "<red>",$weather["solar"]; 
else if ($weather["solar"] >=500) echo "<orange>",$weather["solar"]; 
else if ($weather["solar"] >=300) echo "<orange>",$weather["solar"]; 
else if ($weather["solar"] >=1) echo "<orange>",$weather["solar"]; 
...
<path fill="<?php if($lux>40000){echo " rgba(208,95,45,1)";} else echo "currentcolor"?>"   d=" M 7.00 42.00 C 17.00 41.99 27.00 42.00 37.00 42.00 C 37.00 43.67 37.00 45.33 37.00 47.00 C 27.00 47.00 17.00 47.00 7.00 47.00 C 7.00 45.33 7.00 43.67 7.00 42.00 Z" />
<path fill="<?php if($lux>30000){echo " rgba(208,95,45,1)";} else echo "currentcolor"?>"   d=" M 7.00 48.00 C 17.00 48.00 27.00 48.00 37.00 48.00 C 37.00 49.67 37.00 51.33 37.00 53.00 C 27.00 53.00 17.00 53.00 7.00 53.00 C 7.00 51.33 7.00 49.67 7.00 48.00 Z" />
<path fill="<?php if($lux>20000){echo " rgba(208,95,45,1)";} else echo "currentcolor"?>"   d=" M 7.00 54.00 C 17.00 54.00 27.00 54.00 37.00 54.00 C 37.00 55.67 37.00 57.33 37.00 59.00 C 27.00 59.00 17.00 59.00 7.00 59.00 C 7.00 57.33 7.00 55.67 7.00 54.00 Z" />
<path fill="<?php if($lux>10000){echo " rgba(208,95,45,1)";} else echo "currentcolor"?>"   d=" M 7.00 60.00 C 17.00 60.00 27.00 60.00 37.00 60.00 C 37.00 61.67 37.00 63.33 37.00 65.00 C 27.00 65.00 17.00 65.00 7.00 65.00 C 7.00 63.33 7.00 61.67 7.00 60.00 Z" />
<path fill="<?php if($lux>5000){echo " rgba(208,95,45,1)";} else echo "currentcolor"?>"   d=" M 7.00 66.00 C 17.00 66.00 27.00 66.00 37.00 66.00 C 37.00 67.67 37.00 69.33 37.00 71.00 C 27.00 71.00 17.00 71.00 7.00 71.00 C 7.00 69.33 7.00 67.67 7.00 66.00 Z" />
<path fill="<?php if($lux>0){echo " rgba(208,95,45,1)";} else echo "currentcolor"?>"   d=" M 7.00 72.00 C 17.00 72.00 27.00 72.00 37.00 72.00 C 37.00 73.67 37.00 75.33 37.00 77.00 C 27.00 77.00 17.00 77.00 7.00 77.00 C 7.00 75.33 7.00 73.67 7.00 72.00 Z" /></svg>
