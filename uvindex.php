...
.indoorhomesvg1{margin-top:-2px;left:20px;color:rgba(57,61,64,1);margin-left:8px}.indoortrendhouse1{position:absolute;margin-left:143px;margin-top:71px;font-size:.55rem;z-index:1;color:#fff}.indoorhomevalue1{position:relative;margin-top:-84px;left:0;font-size:23px;padding-right:4px;padding-left:0}indoorblue1,indoorgreen1,indoororange1,indoorred1,indooryellow1{font-family:weathertext,Arial,Helvetica,system;width:3.2rem;height:2.5rem;font-size:.8rem;padding-top:7px;color:#fff;border-bottom:10px solid rgba(56,56,60,1);display:flex;align-items:center;justify-content:center;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;border-radius:3px;position:absolute;margin-left:131px;top:-5px}.raincontainer1,.uvcontainer1{font-family:weathertext,system;position:relative;margin:40px 10px 10px 40px;float:left;-o-font-smoothing:antialiasedleft:0;bottom:0;right:0}indoorred1{background:rgba(211,93,78,1)}indoororange1{background:rgba(208, 95, 45,1)}indoorgreen1{background:#9aba2f}indoorblue1{background:#01a4b4}indooryellow1{background:rgba(233,171,74,1)}.raincontainer1{left:91px;top:47px}.raintoday1{font-family:weathertext,Arial,Helvetica,system;width:3.1rem;height:2.5rem;font-size:.8rem;padding-top:7px;color:#fff;background:rgba(59,156,172,1);border-bottom:8px solid rgba(56,56,60,1);display:flex;align-items:center;justify-content:center;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;border-radius:3px}smalluvunit{font-size:.55rem;font-family:Arial,Helvetica,system;font-weight:600}

.uvcontainer1{left:-30px;top:-10px}
.uvtoday1,.uvtoday1-3,.uvtoday11,.uvtoday4-5,.uvtoday6-8,.uvtoday9-10{font-family:weathertext,Arial,Helvetica,system;width:9rem;height:8.5rem;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;display:flex}.uvtoday1,.uvtoday1-3,.uvtoday11,.uvtoday4-5,.uvtoday6-8,.uvtoday9-10{font-size:3rem;padding-top:7px;color:#fff;border-bottom:15px solid rgba(56,56,60,1);align-items:center;justify-content:center;border-radius:3px}
...
.solartoday1,.solartoday200,.solartoday500,.solartoday1000{font-family:weathertext,Arial,Helvetica,system;width:6rem;height:4.5rem;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;display:flex}.solartoday1,.solartoday200,.solartoday500,.solartoday1000{font-size:2rem;padding-top:2px;color:#fff;border-bottom:15px solid rgba(56,56,60,1);align-items:center;justify-content:center;border-radius:3px}
...
.luxtoday1,.luxtoday200,.luxtoday500,.luxtoday1000{font-family:weathertext,Arial,Helvetica,system;width:6rem;height:4.5rem;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;display:flex}.luxtoday1,.luxtoday200,.luxtoday500,.luxtoday1000{font-size:1.25rem;padding-top:2px;color:#fff;border-bottom:15px solid rgba(56,56,60,1);align-items:center;justify-content:center;border-radius:3px}
...
.advisory{position:absolute;font-size:1rem;line-height:10px;display:inline;width:150px;margin-top:40px;left:120px;} 
.advisoryguide{position:absolute;font-size:1rem;line-height:10px;display:inline;width:300px;margin-top:5px;left:3px;text-align:left;} 
</style>
</head>
<body>
...
else if ($weather["solar"]>=500) {echo '<div class=solsartoday500>'.number_format($weather["solar"],0)."<smalluvunit> &nbsp;W/m<sup>2</sup>";}
