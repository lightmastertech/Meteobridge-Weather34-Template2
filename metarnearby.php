...
actual{font-size:0.95rem;float:right;position:absolute;left:105px;top:20px;-webkit-border-radius:4px;-moz-border-radius:4px;-o-border-radius:4px;border-radius:4px;background:rgba(61, 64, 66, 1.000);padding:5px;}.uvmaxi3{position:absolute;left:-30px;color:rgba(0, 154, 171, 1.000);margin-top:-40px;font-size:16px;width:240px;}.uvmaxi3 span{color:#aaa}.hitemp{color:#aaa;font-size:13px;}.hitemp span{color:rgba(255, 124, 57, 1.000)}.hitemp span2{color:#aaa;font-size:1.1em;margin-left:4px;}
...
.maxword,.tword{position:absolute;margin-top:-31px;font-size:.75rem;z-index:1;color:#fff}.maxword{margin-left:10px}.tword{margin-left:10px}.windword{position:absolute;margin-top:-30px;font-size:.75rem;z-index:1;color:#fff;margin-left:10px}
.metarwindtoday0,.metarwindtoday5,.metarwindtoday10,.metarwindtoday20,.metarwindtoday25,.metarwindtoday30{font-family:weathertext,Arial,Helvetica,system;width:6rem;height:3.5rem;-webkit-border-radius:3px;-moz-border-radius:3px;-o-border-radius:3px;display:flex}.metarwindtoday0,.metarwindtoday5,.metarwindtoday10,.metarwindtoday15,.metarwindtoday20,.metarwindtoday25,.metarwindtoday30{font-size:1.5rem;padding-top:0;color:#fff;border-bottom:10px solid rgba(56,56,60,1);align-items:center;justify-content:center;border-radius:3px;margin-bottom:20px;}
...
if ($tempunit=='C' &&  $metar34temperaturec >30) {echo '<div class=metartemptoday30>'.$metar34temperaturec."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34temperaturec >25) {echo '<div class=metartemptoday25>'.$metar34temperaturec."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34temperaturec >20) {echo '<div class=metartemptoday20>'.$metar34temperaturec."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34temperaturec >10) {echo '<div class=metartemptoday10>'.$metar34temperaturec."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34temperaturec >5) {echo '<div class=metartemptoday5>'.$metar34temperaturec."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34temperaturec >-50) {echo '<div class=metartemptoday0>'.$metar34temperaturec."<smalluvunit> &nbsp;&deg;C";}

if ($tempunit=='F' &&  $metar34temperaturef >=90) {echo '<div class=metartemptoday30>'.$metar34temperaturef."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34temperaturef >=77) {echo '<div class=metartemptoday25>'.$metar34temperaturef."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34temperaturef >=68) {echo '<div class=metartemptoday20>'.$metar34temperaturef."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34temperaturef >=50) {echo '<div class=metartemptoday10>'.$metar34temperaturef."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34temperaturef >=41) {echo '<div class=metartemptoday5>'.$metar34temperaturef."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34temperaturef >-50) {echo '<div class=metartemptoday0>'.$metar34temperaturef."<smalluvunit> &nbsp;&deg;F";}


?></smalluvunit></div></div>
<div class="tword">Temperature</div></div>
...
<path fill="<?php if($metar34temperaturec>-50){echo "rgba(0, 153, 170, 1)";} else echo "currentcolor"?>"   opacity="0.8"  d=" M 7.00 72.00 C 17.00 72.00 27.00 72.00 37.00 72.00 C 37.00 73.67 37.00 75.33 37.00 77.00 C 27.00 77.00 17.00 77.00 7.00 77.00 C 7.00 75.33 7.00 73.67 7.00 72.00 Z" /></svg>
 ...
 if ($tempunit=='C' &&  $metar34dewpointc >30) {echo '<div class=metardewtoday30>'.$metar34dewpointc."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34dewpointc >25) {echo '<div class=metardewtoday25>'.$metar34dewpointc."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34dewpointc >20) {echo '<div class=metardewtoday20>'.$metar34dewpointc."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34dewpointc >10) {echo '<div class=metardewtoday10>'.$metar34dewpointc."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34dewpointc >5) {echo '<div class=metardewtoday5>'.$metar34dewpointc."<smalluvunit> &nbsp;&deg;C";}
else if ($tempunit=='C' &&  $metar34dewpointc >-50) {echo '<div class=metardewtoday0>'.$metar34dewpointc."<smalluvunit> &nbsp;&deg;C";}

if ($tempunit=='F' && $metar34dewpointf >=90) {echo '<div class=metardewtoday30>'.$metar34dewpointf."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34dewpointf >=77) {echo '<div class=metardewtoday25>'.$metar34dewpointf."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34dewpointf >=68) {echo '<div class=metardewtoday20>'.$metar34dewpointf."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34dewpointf >=50) {echo '<div class=metardewtoday10>'.$metar34dewpointf."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34dewpointf >=41) {echo '<div class=metardewtoday5>'.$metar34dewpointf."<smalluvunit> &nbsp;&deg;F";}
else if ($tempunit=='F' &&  $metar34dewpointf >-50) {echo '<div class=metardewtoday0>'.$metar34dewpointf."<smalluvunit> &nbsp;&deg;F";}
...
?></smalluvunit></div></div> 
 <div class="maxword">&nbsp;&nbsp;Dewpoint</div>
...
<actual>Temp | Dewpoint | Humidity</actual>       
...
else if ($metar34windspeedkmh >0) {echo '<div class=metarwindtoday10>'.$metar34windspeedkmh."<smalluvunit>&nbsp; km/h";}
?></smalluvunit></div></div>
<div class="windword">Wind Speed</div>
<?php 
//mph
if ($metar34windspeedmph >=31.06) {echo '<div class=metarwindtoday30>'.$metar34windspeedmph."<smalluvunit> &nbsp;mph";}
else if ($metar34windspeedmph >=24.85) {echo '<div class=metarwindtoday25>'.$metar34windspeedmph."<smalluvunit> &nbsp;mph";}
else if ($metar34windspeedmph >=18.6) {echo '<div class=metarwindtoday20>'.$metar34windspeedmph."<smalluvunit> &nbsp;mph";}
else if ($metar34windspeedmph >=0) {echo '<div class=metarwindtoday10>'.$metar34windspeedmph."<smalluvunit> &nbsp;mph";}
?></smalluvunit></div>
<div class="windword">Wind Speed</div>
<?php 
//kts
if ($metar34windspeedkts >=26.9) {echo '<div class=metarwindtoday30>'.$metar34windspeedkts."<smalluvunit> &nbsp;kts";}
else if ($metar34windspeedkts >=21.5) {echo '<div class=metarwindtoday25>'.$metar34windspeedkts."<smalluvunit> &nbsp;kts";}
else if ($metar34windspeedkts >=16.19) {echo '<div class=metarwindtoday20>'.$metar34windspeedkts."<smalluvunit> &nbsp;kts";}
else if ($metar34windspeedkts >=0) {echo '<div class=metarwindtoday10>'.$metar34windspeedkts."<smalluvunit> &nbsp;kts";}
?></smalluvunit></div>
<div class="windword">Wind Speed</div>
...
</span> <div class="hitemp"><?php echo "Location <yellow>",$metar34stationname  ;?></yellow> 6<green>km</green> (3.2<green>mi</green>)
 <div class="lotempraw">
<?php //metar raw
...
<div class="provided">   
&nbsp;<?php echo $info?> 
Metar Aviation API Data Provided by <a href="https://www.checkwx.com/" title="https://www.checkwx.com/" target="_blank">https://www.checkwx.com/</a> <?php echo $info;?> CSS/SVG/PHP scripts by <a href="https://weather34.com" title="weather34.com" target="_blank">weather34.com  &copy; 2015-<?php echo date('Y');?></a></div>
</body>
</html>